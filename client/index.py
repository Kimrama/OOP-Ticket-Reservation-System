...
class Meal_Page(ttk.Frame) :
    ...
    def create_paylod(self):
        self.controller.cache["price"] = int(self.total_price) +  int(self.controller.cache['price'])
    ...
    def create_widgets_meal(self) :
        ...
        self.image1 = PhotoImage(file='./src/food01.png')
        self.resize_image1 = self.image1.subsample(7)

        self.image2 = PhotoImage(file='./src/food02.png')
        self.resize_image2 = self.image2.subsample(7)

        self.image3 = PhotoImage(file='./src/food03.png')
        self.resize_image3 = self.image3.subsample(7)

        self.image4 = PhotoImage(file='./src/food04.png')
        self.resize_image4 = self.image4.subsample(7)

        self.image5 = PhotoImage(file='./src/food05.png')
...
class Summation_Page(ttk.Frame) :
    ...
    def update_price(self,error_label,coupon_entry,apply_coupon_button) :
        if self.validate_coupon() :
            ...
            print(self.controller.cache["price"])
...
class Seat_page(ttk.Frame) :
    ...
    def create_widgets_seat(self) :
        ...
        self.img1 = PhotoImage(file='./src/armchair.png')
...
class Bogie_Page(ttk.Frame) :
    ...
    def create_widgets_bogie(self) :
        ...
        self.photo = tk.PhotoImage(file='./src/vehicle.png')
        ...
        for data in bogie_list :
            ...
            train_frame = ttk.LabelFrame(list_frame, bootstyle="info", text=f"train id: {data[key][sub_key_list[0]]}", width=800, height=50)
            train_frame.pack(padx=10, pady=10)
            
            info_train = ttk.Label(train_frame, text=f" Bogie No. :     {key}    ", font=info_font)
...
class Train_Page(ttk.Frame) :
    ...
    def pop_train_not_found(self) :
        info_font = ("Helvetica", 20)
        aleart_label = ttk.Label(self, bootstyle="danger",text="Train not found",font=info_font)
        aleart_label.pack()
    ...
    def create_widgets_train(self) :
        ...
        # Keep a reference to the PhotoImage object
        self.photo = tk.PhotoImage(file='./src/train2.png')
...
class Route_Page(ttk.Frame) :
    ...
    def create_widgets_route(self):
        ...
        # Keep a reference to the PhotoImage object
        self.photo = tk.PhotoImage(file='./src/destination.png')
        self.resized_image = self.photo.subsample(5)
        image_label = ttk.Label(
            picture_frame,
            image=self.resized_image,
...
class Login_Page(ttk.Frame) :
    ...
    def create_widgets_login(self) :
        ...
        #image
        self.photo_info = tk.PhotoImage(file='./src/file.png')
...
class Main_Page(ttk.Frame) :
    ...
    def create_widgets_main(self) :
        ...
        # Keep a reference to the PhotoImage object
        self.photo = tk.PhotoImage(file='./src/train.png')
        self.resized_image = self.photo.subsample(5)
        image_label = ttk.Label(
            main_menu_frame,
            image=self.resized_image,
